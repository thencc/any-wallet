...
import { a as algosdk_minExports } from "./algosdk.min-77fc12a3.js";
...
function requireApp4a2b7e5c() {
  ...
  const s = document.createElement("template"), p = e2.isMobile() ? "pera-wallet-modal-header pera-wallet-modal-header--mobile" : "pera-wallet-modal-header pera-wallet-modal-header--desktop";
  s.innerHTML = `
  <div class="${p}">
      ${d() && e2.isMobile() ? "" : `<div class="pera-wallet-modal-header__brand">
...
`;
  class m extends HTMLElement {
    constructor() {
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        ...
        e3.textContent = r, this.shadowRoot.append(s.content.cloneNode(true), e3), this.onClose();
      }
    }
    onClose() {
      var n2;
  ...
  <div id="pera-wallet-connect-modal-desktop-mode" class="pera-wallet-connect-modal-desktop-mode pera-wallet-connect-modal-desktop-mode--default">
      ...
      <div class="pera-wallet-connect-modal-desktop-mode__default-view">
        <div class="pera-wallet-accordion-item pera-wallet-accordion-item--active pera-wallet-accordion-item--web-wallet">
          ...
          ${"Chrome" === e2.detectBrowser() ? '<div class="pera-wallet-connect-modal-desktop-mode__web-wallet-iframe"></div>' : `<div class="pera-wallet-connect-modal-desktop-mode__web-wallet">
          <div>
            <div
  ...
  class y extends HTMLElement {
    constructor() {
      super(), this.attachShadow({ mode: "open" }), this.shadowRoot && (this.shadowRoot.append(b.content.cloneNode(true), v, C), this.shadowRoot.addEventListener("click", (e3) => {
    ...
    connectedCallback() {
      ...
      if ("false" === t2 && (null == a2 || a2.setAttribute("style", "display:none")), this.handleChangeView(), "Chrome" === e2.detectBrowser() && this.shadowRoot) {
        const e3 = this.shadowRoot.querySelector(".pera-wallet-connect-modal-desktop-mode__web-wallet-iframe");
        e3 && "true" === this.getAttribute("is-web-wallet-avaliable") && window.onWebWalletConnect(e3);
      }
    }
    handleChangeView() {
      var e3, n2, t2;
    ...
    renderQRCode() {
      var e3;
      const n2 = this.getAttribute("uri"), t2 = "false" === this.getAttribute("is-web-wallet-avaliable") ? 250 : 205;
      if (n2) {
        const a2 = new o.default({ width: t2, height: t2, type: "svg", data: n2, image: w, dotsOptions: { color: "#000", type: "extra-rounded" }, imageOptions: { crossOrigin: "anonymous", margin: 10 }, cornersSquareOptions: { type: "extra-rounded" }, cornersDotOptions: { type: "dot" } }), l2 = null === (e3 = this.shadowRoot) || void 0 === e3 ? void 0 : e3.getElementById("pera-wallet-connect-modal-connect-qr-code");
        l2 && a2.append(l2);
      }
    }
    onClickDownload() {
  ...
  class E extends HTMLElement {
    constructor() {
      ...
      if (super(), this.attachShadow({ mode: "open" }), M.innerHTML = '\n  <div class="pera-wallet-connect-modal-touch-screen-mode">\n    <pera-wallet-connect-modal-information-section></pera-wallet-connect-modal-information-section>\n\n    <div>\n      <a\n        id="pera-wallet-connect-modal-touch-screen-mode-launch-pera-wallet-button"\n        class="pera-wallet-connect-modal-touch-screen-mode__launch-pera-wallet-button"\n        rel="noopener noreferrer"\n        target="_blank">\n        Launch Pera Wallet\n      </a>\n\n      <div\n        class="pera-wallet-connect-modal-touch-screen-mode__new-to-pera-box">\n        <p\n          class="pera-wallet-connect-modal-touch-screen-mode__new-to-pera-box__text"\n          >\n          New to Pera?\n        </p>\n      </div>\n\n      <a\n        href="https://perawallet.app/download/"\n        class="pera-wallet-connect-modal-touch-screen-mode__install-pera-wallet-button"\n        rel="noopener noreferrer"\n        target="_blank">\n        Install Pera Wallet\n      </a>\n    </div>\n  </div>\n', this.shadowRoot) {
        ...
        t2.textContent = k, this.shadowRoot.append(M.content.cloneNode(true), t2);
        ...
        a2 && o2 && (a2.setAttribute("href", e2.generatePeraWalletConnectDeepLink(o2)), a2.addEventListener("click", () => {
          this.onClickLaunch();
        }));
      }
    }
  ...
  `, this.shadowRoot) {
        const e3 = document.createElement("style");
        e3.textContent = k, this.shadowRoot.innerHTML = "", this.shadowRoot.append(M.content.cloneNode(true), e3);
      }
    }
  }
  ...
  i(z);
  const Z = document.createElement("template"), A = e2.isMobile() ? `${e2.PERA_WALLET_MODAL_CLASSNAME} ${e2.PERA_WALLET_MODAL_CLASSNAME}--mobile` : `${e2.PERA_WALLET_MODAL_CLASSNAME} ${e2.PERA_WALLET_MODAL_CLASSNAME}--desktop`;
  class H extends HTMLElement {
    constructor() {
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        const n2 = document.createElement("style");
        n2.textContent = z, d() && e2.isMobile() ? (Z.innerHTML = `
        <div class="${A}">
      ...
      `, this.shadowRoot.append(Z.content.cloneNode(true), n2)) : (Z.innerHTML = `
          <div class="${A}">
        ...
        `, this.shadowRoot.append(Z.content.cloneNode(true), n2));
      }
    }
  }
...
`;
    ...
    constructor() {
      ...
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        ...
        null == l2 || l2.addEventListener("click", () => {
          this.onClose(), window.open(e2.generatePeraWalletAppDeepLink(), "_blank");
        });
      }
    }
    connectedCallback() {
      const n2 = window.open(e2.generatePeraWalletAppDeepLink(), "_blank");
  ...
  i(W);
  const I = document.createElement("template"), D = e2.isMobile() ? "pera-wallet-connect-modal-information-section pera-wallet-connect-modal-information-section--mobile" : "pera-wallet-connect-modal-information-section pera-wallet-connect-modal-information-section--desktop";
  I.innerHTML = `
  <section class="${D}">
    <img
...
`;
  ...
  U.innerHTML = `
  <div class="${e2.PERA_WALLET_MODAL_CLASSNAME} pera-wallet-sign-txn-modal">
    <div class="pera-wallet-modal__body">
...
`;
  class Q extends HTMLElement {
    constructor() {
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        const e3 = document.createElement("style");
        e3.textContent = G, this.shadowRoot.append(U.content.cloneNode(true), e3);
      }
    }
  }
...
function requireIndex42ef4f76() {
  ...
  function s(e3, t2, n2, a2) {
    return new (n2 || (n2 = Promise))(function(o2, r2) {
      ...
      function i2(e4) {
        var t3;
        e4.done ? o2(e4.value) : (t3 = e4.value, t3 instanceof n2 ? t3 : new n2(function(e5) {
          e5(t3);
        })).then(l2, s2);
      }
      i2((a2 = a2.apply(e3, t2 || [])).next());
    });
  }
  class i extends Error {
    constructor(e3, t2, ...n2) {
      super(...n2), Error.captureStackTrace && Error.captureStackTrace(this, i), this.name = "PeraWalletConnectError", this.data = e3, this.message = t2;
    }
  }
  const d = new class {
    constructor(e3) {
    ...
    sendMessage({ message: e3, targetWindow: t2, origin: n2, timeout: a2 = 1e3 }) {
      setTimeout(() => {
        const a3 = { channel: this.channel, message: e3 };
  ...
  function c() {
    ...
    return e3 instanceof HTMLMetaElement && (n2 = e3.content), t2 instanceof HTMLMetaElement && (a2 = t2.content), { title: n2, description: a2, url: window.location.origin, favicon: u()[0] };
  }
  function u() {
    const e3 = document.getElementsByTagName("link"), t2 = [];
    for (let n2 = 0; n2 < e3.length; n2++) {
      const a2 = e3[n2], o2 = a2.getAttribute("rel");
      if (o2 && o2.toLowerCase().indexOf("icon") > -1) {
        const e4 = a2.getAttribute("href");
  ...
  function p(e3) {
    return new Promise((t2, n2) => {
      try {
        const a2 = window.open(e3, "_blank");
        let o2 = 0;
  ...
  function g() {
    const e3 = w("pera-wallet-sign-txn-modal-wrapper");
    e3.innerHTML = "<pera-wallet-sign-txn-modal></pera-wallet-sign-txn-modal>";
    const t2 = e3.querySelector("pera-wallet-sign-txn-modal");
    return t2 ? (n2 = t2, a2 = "pera-wallet-sign-txn-modal__body__content", new Promise((e4) => {
      var t3;
      const o2 = null === (t3 = n2.shadowRoot) || void 0 === t3 ? void 0 : t3.querySelector(`.${a2}`);
      if (o2)
        return e4(o2);
      const r2 = new MutationObserver(() => {
        o2 && (e4(o2), r2.disconnect());
      });
      r2.observe(n2, { childList: true, subtree: true });
    })) : Promise.reject();
    var n2, a2;
  }
  function m(e3) {
    h("pera-wallet-sign-txn-modal-wrapper"), e3 && e3(new i({ type: "SIGN_TXN_CANCELLED" }, "Transaction sign is cancelled"));
  }
  function h(e3) {
  ...
  function R(e3 = true) {
    let t2 = M;
    const n2 = W();
    return e3 && n2 && (t2 = `${t2}?browser=${encodeURIComponent(n2)}`), t2;
  }
  function x(e3) {
    const t2 = new URL(e3);
    return t2.searchParams.append("embedded", "true"), t2.toString();
  }
  function B({ isWebWalletAvailable: e3, shouldDisplayNewBadge: t2, shouldUseSound: n2 }) {
    return { open: (a2 = { isWebWalletAvailable: e3, shouldDisplayNewBadge: t2, shouldUseSound: n2 }, (e4) => {
      if (!document.getElementById("pera-wallet-connect-modal-wrapper")) {
        const t3 = w("pera-wallet-connect-modal-wrapper"), n3 = `${e4}&algorand=true`, { isWebWalletAvailable: o2, shouldDisplayNewBadge: r2, shouldUseSound: l2 } = a2;
        t3.innerHTML = `<pera-wallet-connect-modal uri="${n3}" is-web-wallet-avaliable="${o2}" should-display-new-badge="${r2}" should-use-sound="${l2}"></pera-wallet-connect-modal>`;
      }
    }), close: () => h("pera-wallet-connect-modal-wrapper") };
    var a2;
  }
  "undefined" != typeof window && (window.global = window, window.Buffer = window.Buffer || buffer.Buffer, Promise.resolve().then(function() {
    ...
    get isConnected() {
      var e3;
      return "mobile" === this.platform ? !!this.connector : "web" === this.platform && !!(null === (e3 = f()) || void 0 === e3 ? void 0 : e3.accounts.length);
    }
        ...
        try {
          ...
          a2 && (window.onWebWalletConnect = c2), this.connector = new o.default({ bridge: this.bridge || r2 || "https://bridge.walletconnect.org", qrcodeModal: B({ isWebWalletAvailable: a2, shouldDisplayNewBadge: s2, shouldUseSound: d2 }) }), yield this.connector.createSession({ chainId: this.chainId || 4160 }), function(e4) {
            ...
            null == s3 || s3.addEventListener("click", () => {
              e4(), h("pera-wallet-connect-modal-wrapper");
            });
    ...
    reconnectSession() {
      return new Promise((e3, t2) => s(this, void 0, void 0, function* () {
        ...
        try {
          ...
          yield this.disconnect(), t2(new i({ type: "SESSION_RECONNECT", detail: e4 }, e4.message || "There was an error while reconnecting to Pera Wallet"));
        }
      }));
    }
    disconnect() {
    ...
    signTransactionWithMobile(e3) {
      return s(this, void 0, void 0, function* () {
        const t2 = (n2 = "algo_signTxn", a2 = [e3], { id: Date.now() * Math.pow(10, 3) + Math.floor(Math.random() * Math.pow(10, 3)), jsonrpc: "2.0", method: n2, params: a2 });
        var n2, a2;
        try {
          try {
          ...
          h("pera-wallet-redirect-modal-wrapper"), h("pera-wallet-sign-txn-toast-wrapper");
        }
      });
    }
    signTransactionWithWeb(e3, t2) {
      return new Promise((n2, a2) => {
        ...
        "Chrome" === W() ? g().then((t3) => {
          ...
          t3 && d.sendMessage({ message: { type: "SIGN_TXN", txn: e3 }, origin: o2.TRANSACTION_SIGN, targetWindow: t3 });
          const r2 = setInterval(() => {
    ...
    signTransaction(e3, t2) {
      return s(this, void 0, void 0, function* () {
        if ("mobile" === this.platform && (L() ? w("pera-wallet-redirect-modal-wrapper").innerHTML = "<pera-wallet-redirect-modal></pera-wallet-redirect-modal>" : !L() && this.shouldShowSignTxnToast && (w("pera-wallet-sign-txn-toast-wrapper").innerHTML = "<pera-wallet-sign-txn-toast></pera-wallet-sign-txn-toast>"), !this.connector))
        ...
        const n2 = e3.flatMap((e4) => e4.map((e5) => function(e6, t3) {
          ...
          const a2 = { txn: (o2 = e6.txn, Buffer.from(r.default.encodeUnsignedTransaction(o2)).toString("base64")) };
          var o2;
