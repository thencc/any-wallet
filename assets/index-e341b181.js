...
`;
  ...
  i(z);
  const O = document.createElement("template"), W = n.isMobile() ? "defly-wallet-connect-modal-information-section defly-wallet-connect-modal-information-section--mobile" : "defly-wallet-connect-modal-information-section defly-wallet-connect-modal-information-section--desktop";
  O.innerHTML = `
  <section class="${W}">
...
`;
  class H extends HTMLElement {
    constructor() {
      ...
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        const e3 = document.createElement("style");
        e3.textContent = z, this.shadowRoot.append(O.content.cloneNode(true), e3);
  ...
  class Z extends HTMLElement {
    ...
    connectedCallback() {
      ...
      null == e3 || e3.addEventListener("click", () => {
        ...
        var n3;
        if (G.innerHTML = P, this.shadowRoot) {
...
`;
  class $ extends HTMLElement {
    constructor() {
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        const e3 = document.createElement("style");
        e3.textContent = j, this.shadowRoot.append(q.content.cloneNode(true), e3);
...
`;
  class Q extends HTMLElement {
    constructor() {
      if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
        const n2 = document.createElement("style");
        n2.textContent = U, this.shadowRoot.append(Y.content.cloneNode(true), n2);
      }
    }
  }
